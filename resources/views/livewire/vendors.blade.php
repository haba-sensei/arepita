...
<div>
    ...
    <div x-data="{ open: @entangle('showCreate') }">
        <x-modal-lg confirmText="{{ __('Save') }}" action="save" :clickAway="false">
            ...
            <hr class="mt-5" />
            <div class="grid grid-cols-2 space-x-4">
                <x-checkbox title="{{ __('Package Delivery Vendor') }}" name="is_package_vendor"
                    description="{{ __('Check this if the vendor is for package delivery') }}" :defer="false" />

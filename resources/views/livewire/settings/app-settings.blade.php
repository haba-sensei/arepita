            ...
            <div class="">
                <div class='grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3'>
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500">{{__('Note: For example if you want to allow phone from Ghana you enter GH')}}</p>
                    </div>
                    {{-- Working --}}
                    <div class="block mt-4 text-sm">
                        <p>{{__('Enable Firebase Phone OTP for verification')}}</p>
                        <x-checkbox title="{{__('Enable')}}" name="enableOTP" :defer="true" />
                    </div>

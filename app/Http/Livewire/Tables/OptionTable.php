...
class OptionTable extends BaseTableComponent
{
    ...
    public function query()
    {
        ...
        if( !Auth::user()->hasRole('manager') ){
            return Option::with('products','option_group');
        }else{
            return Option::with('products','option_group')->where('vendor_id', Auth::user()->vendor_id);
        }
    ...
    public function columns()
    {
        ...
        $columns = [
            ...
            Column::make('Actions')->view('components.buttons.option_actions')
        ];
